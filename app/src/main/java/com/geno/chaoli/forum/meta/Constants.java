...
public class Constants
{
	...
	// activity.json/32/2
	public static final String GET_ACTIVITIES_URL = "https://chaoli.club/index.php/member/activity.json/";
	// statistics.ajax/32
	...
	public static final String conversationListURL = "https://chaoli.club/index.php/conversations/index.json";
	// index.json/1430/p2
	public static final String postListURL = "https://chaoli.club/index.php/conversation/index.json/";
