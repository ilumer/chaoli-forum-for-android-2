...
/**
 * 和OnlineImgTextView类似，只是继承了CheckBox
 * 用于答题时显示选项中的LaTeX
 * Created by jianhao on 16-9-4.
 */
public class OnlineImgCheckBox extends CheckBox {
    ...
    public OnlineImgCheckBox(Context context, List<Post.Attachment> attachmentList)
    {
        super(context);
